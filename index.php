			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="action_code.php" method="post">
					<span class="login100-form-title">
						<span class="h1 text-danger">A</span>dmin Login
					</span>

					<div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
						<input class="input100" type="email" name="a_email" id="a_email" placeholder="Email">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="password" id="a_password" name="a_password" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
